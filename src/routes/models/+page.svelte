...
<section class="min-h-screen bg-black py-12">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="text-center">
			<h1 class="text-5xl font-thin text-white md:text-6xl">Our Models</h1>
		...
		<div class="mt-12 flex flex-wrap items-center justify-center gap-4">
			<span
				class="flex items-center gap-2 text-xs font-light tracking-wider text-gray-500 uppercase"
			>
			...
			{#each categories as category}
				<button
					...
					class="border px-6 py-2 text-xs font-light tracking-widest uppercase transition-all {selectedCategory ===
					category.value
		...
		{:else}
			<div class="mt-24 text-center">
				...
				<button
					...
					class="mt-4 border border-red-900 px-6 py-2 text-xs font-light tracking-widest text-white uppercase transition-all hover:bg-red-900/20"
				>
					View All Models
				</button>
			</div>
